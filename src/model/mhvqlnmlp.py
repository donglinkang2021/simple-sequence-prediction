...
class Model(nn.Module):
    def __init__(self, vocab_size:int, d_model:int, input_dim:int, output_dim:int, n_head:int):
...
if __name__ == "__main__":
    ...
    import numpy as np
    B, T, D = 32, 10, 1
    model = Model(vocab_size=16, d_model=64, input_dim=D, output_dim=1, n_head=2)
